...
6. BlueXP:
    1. [UMF UI Board](https://jira.ngage.netapp.com/secure/RapidBoard.jspa?rapidView=4508&quickFilter=26426#)
    2. OCCM
        1. [Dev](https://dev.console.bluexp.netapp.com/)
        2. [Staging](https://staging.cloudmanager.netapp.com/)
        3. [Prod](https://console.bluexp.netapp.com/)
        4. [Dev Teamcity](https://teamcity.platform.bluexp.netapp.com/buildConfiguration/OccmServices_CmSaas_Dev#all-projects)
        5. [Staging Teamcity](https://teamcity.platform.bluexp.netapp.com/buildConfiguration/OccmServices_CmSaas_Staging_2#all-projects)
        6. [Service Manager V2 Dev Teamcity](https://teamcity.platform.bluexp.netapp.com/buildConfiguration/OccmServiceAgentInfrastructure_ClientDeployment_ServiceManagerV2_CreateServiceMangerV2Dev?mode=builds#all-projects)
    ...
    5. Confluence:
        ...
        2. BlueXP Name Change:
            ...
            2. [Plan and Scope](https://confluence.ngage.netapp.com/display/UMF/BXP+Name+Change+-+Plan+and+Scope)
        3. 2025 Features:
            1. [Features for PVS for INSIGHT-2025 and Post INSIGHT](https://confluence.ngage.netapp.com/display/UMF/Features+for+PVS+for+INSIGHT-2025+and+Post+INSIGHT#FeaturesforPVSforINSIGHT2025andPostINSIGHT-FORINSIGHT)
            2. [25H2 BlueXP UI Planning](https://confluence.ngage.netapp.com/display/UMF/25H2+BlueXP+UI+Planning#id-25H2BlueXPUIPlanning-Insights(snapshotfrom5/26+addl.asksfromPMs))
        4. Connector:
        ...
        5. 2026 Fleet Management:
            ...
            2. [NCL](https://confluence.ngage.netapp.com/spaces/UMF/pages/1355797901/NCL)
            3. [Figma](https://www.figma.com/proto/Bqtf7z63RSMmgsHRt71mey/%F0%9F%8F%8E%EF%B8%8F-Fleet-Management?node-id=74-8816&scaling=scale-down-width&content-scaling=fixed&t=GEBeWW7TMeUyswIO-1)
        6. Browser Caching:
